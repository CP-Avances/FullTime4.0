...
import ROLES_CONTROLADOR from '../../../controlador/configuracion/parametrizacion/catRolesControlador';
...
class PruebasRutas {
    ...
    configuracion(): void {
        ...
        this.router.put('/updateUsers', TokenValidation, ROLES_CONTROLADOR.ActualizarRolUsuario);
