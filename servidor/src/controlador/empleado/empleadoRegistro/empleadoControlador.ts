// SECCION LIBRERIAS
import { ObtenerRuta, ObtenerRutaUsuario, ObtenerRutaVacuna, ObtenerRutaPermisos, ObtenerRutaContrato, ObtenerIndicePlantilla2 } from '../../../libs/accesoCarpetas';
...
class EmpleadoControlador {
  ...
  public async VerificarPlantilla_Automatica(req: Request, res: Response) {
    try {
      ...
      let verificador = ObtenerIndicePlantilla2(workbook, 'EMPLEADOS');
