...
class HorarioRutas {
    ...
    configuracion() {
        ...
        this.router.post('/cargarHorario/verificarPlantilla/upload', [verificarToken_1.TokenValidation, upload.single('uploads')], catHorarioControlador_1.default.VerificarPlantilla);
