...
const detalleCatHorarioControlador_1 = __importDefault(require("../../controlador/horarios/detalleCatHorarioControlador"));
...
class PermisosRutas {
    ...
    configuracion() {
        ...
        this.router.post('/todos_horario', verificarToken_1.TokenValidation, detalleCatHorarioControlador_1.default.ListarUnDetalleTodosHorarios);
