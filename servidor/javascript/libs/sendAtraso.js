...
exports.FormatearHora = exports.FormatearFecha = exports.MinutosAHorasMinutosSegundos = exports.SegundosAMinutosConDecimales = exports.SumarRegistros = exports.EstructurarDatosPDF = exports.PresentarUsuarios = exports.docDefinition = exports.BuscarCorreos = exports.atrasos = exports.ImportarPDF = void 0;
...
const atrasos = function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        setInterval(() => __awaiter(this, void 0, void 0, function* () {
            ...
            `, [1]).then((result) => { return result.rows; });
            let listaSinDuplicados = Array.from(new Set(departamentos));
            listaSinDuplicados.forEach((departamento) => __awaiter(this, void 0, void 0, function* () {
                let gerencia = [];
                gerencia = informacion.filter((item) => item.name_dep === departamento);
                ...
                let n = yield Promise.all(datos.map((suc) => __awaiter(this, void 0, void 0, function* () {
                    suc.empleados = yield Promise.all(suc.empleados.map((o) => __awaiter(this, void 0, void 0, function* () {
                        o.atrasos = yield (0, reportesAtrasosControlador_1.BuscarAtrasos)(today, today, o.id);
                        return o;
                    })));
                    return suc;
                })));
                ...
                let resultadoDepartamento = yield (0, exports.EstructurarDatosPDF)(nuevo);
                resultadoDepartamento.map((obj) => {
                    return obj;
                });
                let definicionDocumento = (0, exports.docDefinition)(resultadoDepartamento);
            ...
            let definicionDocumento = (0, exports.docDefinition)(resultado);
            // Crear el PDF y obtener el buffer de manera asíncrona
            const pdfDocGenerator = pdfMake.createPdf(definicionDocumento);
            // Obtener el buffer del PDF generado
            const pdfBuffer = yield new Promise((resolve, reject) => {
...
const docDefinition = function (datos) {
    return __awaiter(this, void 0, void 0, function* () {
        const today = luxon_1.DateTime.now().toFormat('yyyy-MM-dd');
