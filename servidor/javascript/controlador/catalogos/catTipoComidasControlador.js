    ...
    ActualizarComida(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const datosOriginales = yield database_1.default.query("SELECT * FROM cg_tipo_comidas WHERE id = $1", [id]);
    ...
    ActualizarDetalleMenu(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield database_1.default.query("BEGIN");
                // CONSULTAR DATOSORIGINALES
                const datosOriginales = yield database_1.default.query("SELECT * FROM detalle_menu WHERE id = $1", [id]);
                const [datos] = datosOriginales.rows;
                if (!datos) {
                    // AUDITORIA
                    yield auditoriaControlador_1.default.InsertarAuditoria({
