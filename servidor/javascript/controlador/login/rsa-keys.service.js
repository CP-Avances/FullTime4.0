...
let RsaKeysService = class RsaKeysService {
    constructor() {
        ...
        this.keyLogin = CryptoJS.enc.Utf8.parse(CryptoJS.PBKDF2(this.key, this.salt, { keySize: 8, iterations: 1000 }));
    }
};
RsaKeysService = __decorate([
    (0, core_1.Injectable)({
        providedIn: 'root'
    })
], RsaKeysService);
