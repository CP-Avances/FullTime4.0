...
class EmpleadoControlador {
    ...
    getListaEmpleados(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield database_1.default.query('SELECT id, cedula, codigo,  (nombre || \' \' || apellido) as fullname, name_cargo, name_suc, name_dep, name_regimen  FROM informacion_general ORDER BY fullname ASC');
