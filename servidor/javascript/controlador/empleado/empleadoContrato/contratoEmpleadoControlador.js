    ...
    GuardarDocumentoContrato(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const contrato = yield database_1.default.query('SELECT * FROM empl_contratos WHERE id = $1', [id]);
                ...
                if (!datosOriginales) {
                    ...
                    yield auditoriaControlador_1.default.InsertarAuditoria({
                        ...
                        datosNuevos: '',
                        ip,
                        observacion: `Error al actualizar el documento del contrato con id ${id}`
                    });
                    // FINALIZAR TRANSACCION
                    yield database_1.default.query('COMMIT');
            ...
            try {
                ...
                if (!datosOriginales) {
                    ...
                    yield auditoriaControlador_1.default.InsertarAuditoria({
                        ...
                        datosNuevos: '',
                        ip,
                        observacion: `Error al actualizar el contrato con id ${id}`
                    });
                    // FINALIZAR TRANSACCION
                    yield database_1.default.query('COMMIT');
    ...
    EliminarDocumento(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield database_1.default.query('BEGIN');
                // CONSULTAR DATOS ORIGINALES
                const contratoConsulta = yield database_1.default.query('SELECT * FROM empl_contratos WHERE id = $1', [id]);
