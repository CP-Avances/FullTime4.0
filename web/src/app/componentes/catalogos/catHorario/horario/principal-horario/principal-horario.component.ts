...
export class PrincipalHorarioComponent implements OnInit {
  ...
  getCrearHorario(){
    ...
    if(datosRecuperados){
      ...
      const index = datos.findIndex(item => item.accion === 'Crear Horario');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getVerHorario(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Ver horario');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getEditarHorario(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Editar horario');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getEliminarHorario(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Eliminar horario');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getPlantilla(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => (item.accion === 'Plantilla' && item.id_funcion === 15));
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getDescargarReportes(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => (item.accion === 'Descargar Reportes' && item.id_funcion === 15));
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
