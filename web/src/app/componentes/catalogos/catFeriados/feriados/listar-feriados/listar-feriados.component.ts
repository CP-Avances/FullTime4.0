 ...
 InsertarFeriadoCiudad(id: number) {
  ...
  getCrearFeriado(){
    ...
    if(datosRecuperados){
      ...
      const index = datos.findIndex(item => item.accion === 'Crear Feriado');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getVerFeriado(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Ver Feriados');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getPlantilla(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => (item.accion === 'Plantilla' && item.id_funcion === 14));
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getEditarFeriado(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Editar Feriados');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getEliminarFeriado(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Eliminar Feriados');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getDescargarReportes(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => (item.accion === 'Descargar Reportes' && item.id_funcion === 14));
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
