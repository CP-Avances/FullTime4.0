...
export class EmpleadoGradoComponent {
  ...
  getEditarAsignacionGrado(): boolean {
    return this.tienePermiso('Editar Asignación Grado');
  }

  getEliminarAsignacionGrado(): boolean {
    return this.tienePermiso('Eliminar Asignación Grado');
  }
}
