...
export class ListarTipoComidasComponent implements OnInit {
  ...
  getCrearNuevoMenu(){
    ...
    if(datosRecuperados){
      ...
      const index = datos.findIndex(item => item.accion === 'Crear nuevo menú');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getVerMenu(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Ver menú');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getDetalleMenu(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Detalle menú');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getEditarMenu(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Editar menú');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getEliminarMenu(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => item.accion === 'Eliminar menú');
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
  ...
  getDescargarReportes(){
    ...
    if(datosRecuperados){
      var datos = JSON.parse(datosRecuperados);
      var encontrado = false;
      const index = datos.findIndex(item => (item.accion === 'Descargar reportes' && item.id_funcion === 26));
      if (index !== -1) {
        encontrado = true;
      }
      return encontrado;
