...
export class MainNavComponent implements OnInit {
  ...
  vistaGenero: boolean = false;
  vistaEstadoCivil: boolean = false;
  vistaNacionalidad: boolean = false;
            ...
            this.paginasMG.forEach((row: any) => {
              ...
              switch (row.link) {
                ...
                case 'genero':
                  this.itemUsuarios = true;
                  for (const parametrizacion of this.childrenUsuarios) {
                    if (parametrizacion.url === '/genero') {
                      this.vistaGenero = true;
                    }
                  }
                  if (!this.vistaGenero) {
                    this.childrenUsuarios.push({ name: 'Género', url: '/genero', color: true, ver: true });
                  }
                  break;
                case 'estado-civil':
                  this.itemUsuarios = true;
                  for (const parametrizacion of this.childrenUsuarios) {
                    if (parametrizacion.url === '/estado-civil') {
                      this.vistaEstadoCivil = true;
                    }
                  }
                  if (!this.vistaEstadoCivil) {
                    this.childrenUsuarios.push({ name: 'Estado Civil', url: '/estado-civil', color: true, ver: true });
                  }
                  break;
                case 'nacionalidad':
                  this.itemUsuarios = true;
                  for (const parametrizacion of this.childrenUsuarios) {
                    if (parametrizacion.url === '/nacionalidad') {
                      this.vistaNacionalidad = true;
                    }
                  }
                  if (!this.vistaNacionalidad) {
                    this.childrenUsuarios.push({ name: 'Nacionalidad', url: '/nacionalidad', color: true, ver: true });
                  }
                  break;
                case 'nivelTitulos':
                  this.itemUsuarios = true;
