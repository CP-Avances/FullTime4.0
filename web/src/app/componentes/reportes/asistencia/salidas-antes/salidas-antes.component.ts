...
export class SalidasAntesComponent implements OnInit, OnDestroy {
  ...
  EstructurarDatosPDF(data: any[]): Array<any> {
    ...
    data.forEach((selec: any) => {
      ...
      // CONTAR MINUTOS DE SALIDAS ANTICIPADAS
      selec.empleados.forEach((o: any) => {
        o.salidas.map((sal: any) => {
          const minutos = this.SegundosAMinutosConDecimales(sal.diferencia);
          ...
          table: {
            ...
            body: [
              ...
              ...empl.salidas.map((usu: any) => {
                ...
                const minutos = this.SegundosAMinutosConDecimales(usu.diferencia);
      ...
      data.empleados.forEach((usu: any) => {
        usu.salidas.forEach((sal: any) => {
          ...
          let ele = {
            ...
            fechaTimbre,
            horaTimbre,
            salidaAnticipadaM: minutos.toFixed(2),
            salidaAnticipadaT: tiempo,
          }
