...
const routes: Routes = [
  ...
  { path: 'administrarSucursales', component: PrincipalSucursalUsuarioComponent, canActivate: [AuthGuard], data: { roles: 1 } },
  ...
  { path: 'reporte-timbre-mrl', component: TimbreMrlComponent, canActivate: [AuthGuard], data: { roles: 1 } },
