    ...
    ObtenerEmpresas(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let empresasRows = 0;
                let empresas = yield database_1.default.query("SELECT emp.empresa_codigo, emp.empresa_direccion, emp.empresa_descripcion FROM empresa AS emp WHERE emp.empresa_codigo = $1", [codigo_empresa]).then((result) => {
